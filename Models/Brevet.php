...
private $nom_brevet; 
private $categorie_brevet; 
private $domaine_brevet; 
private $id_cir; 
private $id_pc;
private $id_respo_pc; 
...
public function __construct ($nom_brevet, $categorie_brevet, $domaine_brevet,$description_dmd) {
$this->setNomBrevet($nom_brevet);
$this->setCategorieBrevet($categorie_brevet);
$this->setDomaineBrevet($domaine_brevet);
...
public function setNomBrevet ($nom_brevet) {
	$this->nom_brevet =$nom_brevet;
}
public function setCategorieBrevet ($categorie_brevet) {
	$this->categorie_brevet =$categorie_brevet;
}
public function setDomaineBrevet ($domaine_brevet) {
	$this->domaine_brevet =$domaine_brevet;
}
...
public function getNomBrevet () {
	return $this->nom_brevet;
}
public function getCategorieBrevet () {
	return $this->categorie_brevet;
}
public function getDomaineBrevet () {
	return $this->domaine_brevet ;
}
