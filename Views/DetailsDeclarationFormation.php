...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4" style="font-size: 20px; width: 100%; margin: 0 auto; ">
     <div class="card-header py-3">
         <center>
         	<h4 class="m-0 font-weight-bold text-primary">
         		<span style="float: left; ">Sujet de la formation : 
         			<span style="color: black; "><?php echo $row['SUJET_FORMATION']  ?></span> 
         		</span>
   ...
   <div class="card shadow mb-4" style="font-size: 20px; width: 100% ;margin:0 auto; ">
        <div class="card-header py-3">
        	<h4 class="m-0 font-weight-bold text-primary" >Description de la formation</h4>
  		</div>
  		<div class="card-body">
	...
	<div class="card shadow mb-4" style="font-size: 20px; width: 100% ;margin:0 auto; ">
  		...
  		<div class="row card-body" style="width: 90%; margin: 0 auto; text-align: left;">
    		<div class="col">Nombre de participants</div>
    		<div class="col"><strong><?php echo $row['NOMBRE_PARTICIPANTS']  ?></strong></div>
    		<div class="w-100"></div><br>
    		<div class="col">Plan de la formation</div>
    		<div class="col"><strong><?php echo $row['PLAN_FORMATION']  ?></strong></div>
    		<div class="w-100"></div><br>
