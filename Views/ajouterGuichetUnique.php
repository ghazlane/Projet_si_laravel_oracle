<div class="container">
  <form method="post" action="index.php?action=saveAjoutGuichetUnique">
    <h1>Ajouter utilisateur guichet unique</h1>

    <div class="form-group">
      <input type="text" required="required" name="nom_gu" />
      <label for="input" class="control-label" style="left: 0;">Nom</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="text" required="required" name="prenom_gu" />
      <label for="input" class="control-label" style="left: 0;">Prenom</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="date"  name="date_naissance_gu" />
      <label for="input" class="control-label" style="left: 0;">Date naissance</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="email" required="required" name="email_gu" />
      <label for="input" class="control-label" style="left: 0;">Email</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="password" required="required" name="password_gu" />
    ...
    <div class="form-group">
      <input type="number" required="required" name="num_telephone_gu" />
