<div class="container">
  <form method="post" action="index.php?action=saveDeclarationFormation">
    <h1>Déclaration du lancement d'une formation</h1>

    <div class="form-group">
      <input type="text" required="required" name="sujetFormation" />
      <label for="textarea" class="control-label" style="left: 0;">Sujet de la formation</label><i class="bar"></i>
    </div>
    <div class="form-group">
      <input type="text" required="required" name="themeFormation" />
