              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Connexion Résponsable pool de compétence</h1>
                    <h5 style="color: red;">Mot de passe ou username est incorrect</h5>
                  </div>
                  <br>
                  <form class="user" method="post" action="index.php?action=connexionRespPoolCompetence">
